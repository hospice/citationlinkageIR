...
public class LinkageSearchWithLuceneAnalysisEvaluation22PapersAllExperimentsWith5Stats2 {
	...
	public void runTest() throws Exception {
		...
		BufferedWriter bw = new BufferedWriter(new FileWriter("C:/Users/Hospice/Documents/boruta_data/linkagedata12_12/IR_06_12/"+"evalPrec_.txt"));
		BufferedWriter bwdc = new BufferedWriter(new FileWriter("C:/Users/Hospice/Documents/boruta_data/linkagedata12_12/IR_06_12/"+"evaldc_.txt"));
		BufferedWriter bwScore = new BufferedWriter(new FileWriter("C:/Users/Hospice/Documents/boruta_data/linkagedata12_12/IR_06_12/"+"outScoreb_.txt"));
		BufferedWriter ExbwScore = new BufferedWriter(new FileWriter("C:/Users/Hospice/Documents/boruta_data/linkagedata12_12/IR_06_12/"+"expScore_.txt"));

		
		BufferedWriter OutScoreMetrics = new BufferedWriter(new FileWriter("C:/Users/Hospice/Documents/boruta_data/linkagedata12_12/IR_06_12/"+"OutScoreMetrics_.txt"));

		//BufferedWriter scoreAnalysis = new BufferedWriter(new FileWriter("C:/Users/Hospice/Documents/boruta_data/linkagedata12_12/IR_06_12/"+"analysisScoreNP_4.txt"));
		...
		for(int k = 0; k < algo.length; k++){
			BufferedWriter scoreAnalysis = new BufferedWriter(new FileWriter("C:/Users/Hospice/Documents/boruta_data/linkagedata12_12/IR_06_12/"+"analysisScoreNP_"+k+".txt"));
			...
			String outputAllSentencesFullCitation="";
			String outputAllSentencesFullNP="";
			
			String outputMethodSentencesFullCitation="";
			String outputMethodSentencesFullNP="";
			...
			for(File file:listFromFile){	
				...
				String outLengthStringAllSentences = outLengthArray[0]+" & "+outLengthArray[1];

				String outLengthStringMethodSentences = outLengthArray[2]+" & "+outLengthArray[1];
				...
				outputAllSentencesFullCitation += p1+++" & "+ outLengthStringAllSentences+ " & "+ outputToArray[0].trim()+" &"+
						outputToArray[1].trim()+"\\\\"+"\n";
				outputAllSentencesFullNP += p2+++" & "+ outLengthStringAllSentences+ " & "+ outputToArray[2].trim()+" &"+
						outputToArray[3].trim()+"\\\\"+"\n";

				
				outputMethodSentencesFullCitation += pM1+++" & "+ outLengthStringMethodSentences+ " & "+ outputToArray[4].trim()+" &"+
						outputToArray[5].trim()+"\\\\"+"\n";
				outputMethodSentencesFullNP += pM2+++" & "+ outLengthStringMethodSentences+ " & "+ outputToArray[6].trim()+" &"+
						outputToArray[7].trim()+"\\\\"+"\n";
			...
			outputAllSentencesFullCitation+="\\hline"+"\n";
			OutScoreMetrics.write(outputAllSentencesFullCitation);
			OutScoreMetrics.write("\n\n");

			outputAllSentencesFullNP+="\\hline"+"\n";
			OutScoreMetrics.write(outputAllSentencesFullNP);
			OutScoreMetrics.write("\n\n");
			...
			outputMethodSentencesFullCitation+="\\hline"+"\n";
			OutScoreMetrics.write(outputMethodSentencesFullCitation);
			OutScoreMetrics.write("\n\n");

			outputMethodSentencesFullNP+="\\hline"+"\n";
			OutScoreMetrics.write(outputMethodSentencesFullNP);
			OutScoreMetrics.write("\n\n");

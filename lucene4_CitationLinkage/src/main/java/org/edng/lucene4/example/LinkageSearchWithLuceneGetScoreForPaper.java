...
public class LinkageSearchWithLuceneGetScoreForPaper {
		...
		for(String file:filesPath){	
			...
			for(int k = 0; k < algo.length; k++){
				...
				for(int i=0; i < sentencesL.length; i++){
					...
					arrayLMap.put(i+"	"+textL, Integer.valueOf(lineL[2]));
					//System.out.println(textL);
					doc2.add(new Field("content",i+"	"+textL, Store.YES, Index.ANALYZED));
				...
				TopDocs topDocs = indexSearcher.search(booleanQuery, 300);
